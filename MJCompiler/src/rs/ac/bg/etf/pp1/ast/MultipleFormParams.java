...
public class MultipleFormParams extends FormParamList {

    private FormParamList FormParamList;
    private FormParam FormParam;

    public MultipleFormParams (FormParamList FormParamList, FormParam FormParam) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleFormParams(\n");
